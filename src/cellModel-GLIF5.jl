#=
this file implements the GLIF5 model as defined in:
...
cellModel_file = "cellModel-GLIF5.jl"
cellModel_args = (; thresh, thresh_s, thresh_v, b_s, delta_thresh_s, a_v, b_v, f_v, delta_v,
...
function cellModel_timestep!(i::Number, v, X, u, args)
    ...
    args.thresh_v[i] += args.a_v * v[i] - args.dt * args.b_v * args.thresh_v[i]
end
function cellModel_timestep!(bnotrefrac::AbstractVector, v, X, u, args)
    ...
    @. args.thresh_v += bnotrefrac * args.a_v * v - args.dt * args.b_v * args.thresh_v
end

function cellModel_spiked(i::Number, v, args)
    v[i] > args.thresh[i] + args.thresh_s[i] + args.thresh_v[i]
end
function cellModel_spiked!(bspike::AbstractVector, bnotrefrac::AbstractVector, v, args)
    @. bspike = bnotrefrac & (v > args.thresh + args.thresh_s + args.thresh_v)
end
